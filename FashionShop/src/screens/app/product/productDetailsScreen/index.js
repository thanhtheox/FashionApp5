              ...
              {colors.map(item => (
                <TouchableOpacity
                  style={{
                    ...
                    borderWidth: colorChoose === item.key ? 1 : 0,
                    alignItems: 'center',
                    justifyContent: 'center',
                    width: scale(22),
                    height: scale(22),
                  }}
                  onPress={() => setChooseColor(item.key)}
                  key={item.key}>
                  <View
                    style={{
                      borderRadius: 360,
              ...
              {sizes.map(item => (
                <TouchableOpacity
                  style={{
                    ...
                    borderWidth: 1,
                    borderColor:
                      sizeChoose === item.key ? color.Body : color.Border,
                    width: scale(16),
                    height: scale(16),
                    alignItems: 'center',
                    backgroundColor:
                      sizeChoose === item.key ? color.Body : color.OffWhite,
                  }}
                  onPress={() => setChooseSize(item.key)}
                  key={item.key}>
                  <Text
                    style={{
                      color:
